...
function checkWinConditions(echoes, scores) {
    ...
    if (p1HasEchoWin && !p2HasEchoWin)
        return 'player1';
    if (p2HasEchoWin && !p1HasEchoWin)
        return 'player2';
    ...
    if (p1HasScoreWin && !p2HasScoreWin)
        return 'player1';
    if (p2HasScoreWin && !p1HasScoreWin)
        return 'player2';
