...
const HomePage = () => {
    ...
    const tFast = t * 1.15;
    // Menu rendering based on state
    const renderMenu = () => {
        switch (menuState) {
            case 'main':
                return (_jsxs("div", { className: "menu", children: [_jsx(Link, { to: "/game?mode=human-vs-ai", className: "menu-button", children: "Single Player" }), _jsx("button", { onClick: () => setMenuState('multiplayer'), className: "menu-button", children: "Multiplayer" }), _jsx("button", { onClick: () => setMenuState('ai-training'), className: "menu-button", children: "AI Training" }), _jsx(Link, { to: "/rules", className: "menu-button", children: "Rules" }), _jsx(Link, { to: "/leaderboard", className: "menu-button", children: "Leaderboard" })] }));
            case 'multiplayer':
                return (_jsxs("div", { className: "menu", children: [_jsx(Link, { to: "/game?mode=hotseat", className: "menu-button", children: "Hotseat" }), _jsx("button", { className: "menu-button", disabled: true, style: { opacity: 0.5, cursor: 'not-allowed' }, children: "Online (Coming Soon)" }), _jsx("button", { onClick: () => setMenuState('main'), className: "menu-button back-button", children: "\u2190 Back" })] }));
            case 'ai-training':
                return (_jsxs("div", { className: "menu", children: [_jsx(Link, { to: "/game?mode=ai-training", className: "menu-button", children: "Training" }), _jsx(Link, { to: "/game?mode=ai-vs-ai", className: "menu-button", children: "AI vs AI" }), _jsx("button", { onClick: () => setMenuState('main'), className: "menu-button back-button", children: "\u2190 Back" })] }));
            default:
                return null;
        }
    };
    return (_jsxs("div", { className: "home-page", children: [_jsxs("div", { style: { position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }, children: [_jsxs("svg", { width: "100vw", height: "100vh", viewBox: "0 0 2000 2000", style: { width: '100vw', height: '100vh', display: 'block', position: 'absolute', inset: 0 }, children: [echoes.map((e, i) => {
                                ...
                                return (_jsx("foreignObject", { x: cx - e.size / 2, y: cy - e.size / 2, width: e.size, height: e.size, style: { overflow: 'visible', pointerEvents: 'none', opacity: 0.6 }, children: _jsxs("div", { style: { position: 'relative', width: e.size, height: e.size }, children: [_jsx("div", { className: `echo-3d-pulse ${isOrange ? 'echo-player1' : 'echo-player2'}`, style: { width: e.size, height: e.size, borderRadius: '50%', opacity: 0.6 } }), _jsx("div", { style: {
                                                    position: 'absolute',
                                                    top: `-${e.size * 0.175}px`,
                                ...
                                const isOrange = e.color.main === '#ff9800';
                                return (_jsx("foreignObject", { x: cx - e.size / 2, y: cy - e.size / 2, width: e.size, height: e.size, style: { overflow: 'visible', pointerEvents: 'none', opacity: 0.8 }, children: _jsxs("div", { style: { position: 'relative', width: e.size, height: e.size }, children: [_jsx("div", { className: `echo-3d-pulse ${isOrange ? 'echo-player1' : 'echo-player2'}`, style: { width: e.size, height: e.size, borderRadius: '50%', opacity: 0.8 } }), _jsx("div", { style: {
                                                    position: 'absolute',
                                                    top: `-${e.size * 0.175}px`,
                                                    left: `-${e.size * 0.175}px`,
                                                    width: e.size * 1.35,
        ...
        ` })] }), _jsxs("div", { style: {
                    ...
                    height: '100vh',
                    width: '100%'
                }, children: [_jsx("h1", { children: "Echoes" }), renderMenu()] })] }));
};
